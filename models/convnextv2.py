...
class ConvNeXtV2ForImageClassification_v2(nn.Module):
    """ConvNeXtV2 wrapper for image classification compatible with the project"""

    def __init__(self, num_labels=7, img_size=224, patch_size=16, hidden_dim=512,
                 model_variant='tiny'):
        super(ConvNeXtV2ForImageClassification_v2, self).__init__()
        ...
        # Calculate output dimension - final dimension from dims
...
class ConvNeXtV2ForImageClassification(nn.Module):
    ...
    def __init__(self, num_labels=7, img_size=224, patch_size=16, hidden_dim=512, 
                 model_variant='tiny'):
        super(ConvNeXtV2ForImageClassification, self).__init__()
