...
from auc_util.load_model import build_model as model_loader
...
def get_gradcam_map(model, input_tensor):
    ...
    return cam(input_tensor=input_tensor, targets=None)[0, :]  # (H,W) numpy
...
if __name__ == "__main__":
    ...
    run_xai_auc_cv(
        ...
        device=device,
        print_errors=True,
        out_suffix="gradcam_saliency.csv",
        write_cv_mean=True,
        write_all=True,
    )